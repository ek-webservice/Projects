        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-16 md:mb-20">
            {pricingPlans.map((plan, index) => (
                <GlassCard key={index} className={`p-6 md:p-8 relative flex flex-col h-full ${plan.popular ? 'ring-2 ring-blue-500' : ''}`} hover>
                  {plan.popular && (
                      <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                        <div className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white px-4 py-1.5 rounded-full text-xs md:text-sm shadow-lg whitespace-nowrap">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-12">
            <GlassCard className="p-6 text-center h-full" hover>
              <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-blue-500 to-blue-700 mx-auto mb-4 flex items-center justify-center">
